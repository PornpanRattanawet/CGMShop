...
<body>
    ...
    <div class="container">
        ...
        <form action="Register_db.php" method="post">
			...
			<div class="mb-3">
                <label for="birth" class="form-label">Birthday (ค.ศ.) </label>
			...
			<div class="mb-3">
                ...
                <input type="tel" class="form-control" name="phone" aria-describedby="phone">
            </div>
        ...
        <hr>
        <p>เป็นสมาชิกแล้วใช่ไหม <a href="Login_form.php">คลิ๊กที่นี่</a> เพื่อเข้าสู่ระบบ</p>
    </div>
